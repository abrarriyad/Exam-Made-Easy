...
<html lang="en">
  ...
  <div class="collapse navbar-collapse " id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="StudentResultListServlet">Result List <span class="sr-only">(current)</span></a>
      </li>
      
      <li class="nav-item">
        <a class="nav-link" href="StudentResultListServlet">Teacher List <span class="sr-only">(current)</span></a>
      </li>
  ...
  <tbody>
    ...
    <%!int data=1;%>
      ...
      <c:url var="tempExam" value="ExamControllerServlet">
      	<c:param name="command" value="TEST-QUES"/>
      ...
      <td>
      <a type="submit" class="btn btn-success mr-3" href="${tempExam}">Test Yourself</a>
